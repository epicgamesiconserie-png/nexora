  ...
  return (
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative z-10 max-w-2xl mx-auto px-6 py-24 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4" style={{ textShadow: "0 1px 0 rgba(255,255,255,0.9), 0 2px 0 rgba(200,200,200,0.6), 0 4px 12px rgba(0,0,0,0.5), 0 0 30px rgba(255,255,255,0.35)" }}>Music Coming Soon</h1>
